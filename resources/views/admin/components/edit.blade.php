...
<div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            ...
            <form data-action="/{{ app()->getLocale() }}/admin/component/{{$component->id}}\edit" user-id="{{auth()->user()->id}}" method="POST">
                            ...
                            <div style="padding:20px">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control  @error('type') danger @enderror " name="type_id"
                                        ...
                                        <option value="{{ $type['id'] }}" id="componentoption">
                                    ...
                                    <div class="col-lg-12 d-flex">
                                        <div
                                            class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
                                                ...
                                                id="component_data_type_manual" disabled="" checked="">

                                            <label class="form-check-label fw-medium fs-3 text-gray-900"
                                                for="component_data_type_manual">ხელით მიბმა</label>
                                        </div>
                                        <div
                                            class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
                                            <input class="form-check-input" type="radio" name="component_data_type"
                                                id="component_data_type_connected">
                                            <label class="form-check-label fw-medium fs-3 text-gray-900"
                                                for="component_data_type_connected">დაკავშირებული</label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-12 d-flex">
                                        <div
                                            ...
                                            <input class="form-check-input" type="radio" name="section_data_type"
                                                id="section_data_type_manual" disabled="" checked="">
                                            <label class="form-check-label fw-medium fs-3 text-gray-900"
                                                for="component_data_type_manual">ხელით მიბმა</label>
                                        </div>
                                        <div
                                ...
                                <div class="row" style="justify-content: center;">
                                    <div class="text-center pt-5 pb-10" style=" display:flex;"><button type="reset"
                                            class="btn btn-light btn-lg me-3">გაუქმება</button>
                                        <button type="submit" class="btn btn-primary btn-lg save-btn-component"><span
                                                class="indicator-label">შენახვა</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <div style="padding-top:20px">
                    ...
                    <div class="form-group">
                        ...
                        <div class="flex" style="display: flex;">
                            <select  class="form-control  @error('parent_id') danger @enderror"
                                id="titleselect">
                                @foreach($components as $component)
                ...
                <div class="form-group text-right mb-0">
                    <button class="btn btn-primary waves-effect waves-light mr-1 save-component-fields" type="submit" name="save">
                        {{ trans('admin.save') }}
                    </button>
                </div>
...
<script>
    $(document).ready(function () {
        $('.save-component-fields').click(function (event) {
            ...
            // Loop through the locales and add titles for each locale to the data object
