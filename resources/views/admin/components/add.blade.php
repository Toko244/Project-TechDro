...
<div class="row">
    <div class="col-xl-12">
        <div class="card-box">
            <form data-action="/{{ app()->getLocale() }}/admin/component/create" user-id="{{auth()->user()->id}}"
                method="POST">
                            ...
                            <div style="padding:20px">
                                    ...
                                    <div class="col-lg-12 d-flex">
                                        <div
                                            ...
                                            <input class="form-check-input" type="radio" name="component_data_type"
                                                value="@if(isset($component->component_data_type)) {{$component->component_data_type}} @else manual @endif" id="component_data_type_manual" disabled>
                                        ...
                                        <div
                                            class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
                                            <input class="form-check-input" type="radio" name="component_data_type"
                                                value="@if(isset($component->component_data_type)) {{$component->component_data_type}} @else connected @endif" id="component_data_type_connected" disabled>
                                ...
                                <div class="form-group" id="radioFormGroup">
                                    <div class="col-lg-12 d-flex">
                                        <div class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
                                            <input class="form-check-input" type="radio" name="section_data_type" value="manual" id="section_data_type_manual">
                                            <label class="form-check-label fw-medium fs-3 text-gray-900" for="section_data_type_manual">
                                                ხელით მიბმა
                                            </label>
                                        </div>
                                        <div class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
                                            <input class="form-check-input" type="radio" name="section_data_type" value="automate" id="section_data_type_automate">
                                            <label class="form-check-label fw-medium fs-3 text-gray-900" for="section_data_type_automate">
                                                ავტომატურად დაკავშირებული
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="row" style="justify-content: center;">
                                    <div class="text-center pt-5 pb-10" style="display:flex;">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-lg save-btn-component" id="saveButton" disabled>
                ...
                <div style="padding-top:20px">
                    <div class="form-group">
                        ...
                        <select class="form-control  @error('type') danger @enderror " name="type_id"
                            ...
                            <option value="{{ $component->type_id }}" selected>{{ $key }}</option>
                            @endif
                            @endforeach
...
<script>
    $(document).ready(function () {
        ...
        // Handle validation errors here
                        ...
                        window.location.href = '/{{ app()->getLocale() }}/admin/components';
                    }
