...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            ...
            @if(isset($section))
            <h3>{{ $section->title }}</h3>
            <a href="{{ url(app()->getLocale() . '/admin/section/' . $section->id . '/posts/create') }}" type="button" class="float-right btn btn-info waves-effect width-md waves-light">{{ trans('admin.add_post') }}</a>
            @else
            <h3>{{ $component->title }}</h3>
            <a href="{{ url(app()->getLocale() . '/admin/section/' . $component->id . '/posts/create') }}" type="button" class="float-right btn btn-info waves-effect width-md waves-light">{{ trans('admin.add_post') }}</a>
            @endif
