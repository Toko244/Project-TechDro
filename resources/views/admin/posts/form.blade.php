...
@elseif($component)
    ...
    <div class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
        <input class="form-check-input" type="radio" name="component_data_type" value="manual"
            id="component_data_type_manual" @if ($component->component_data_type == 'manual') checked @else disabled @endif>
        <label class="form-check-label fw-medium fs-3 text-gray-900" for="component_data_type_manual">
            ხელით მიბმა
        </label>
    </div>
    <div class="col-lg-5 form-check form-check-custom form-check-solid form-check-lg">
        <input class="form-check-input" type="radio" name="component_data_type" value="connected"
            id="component_data_type_connected" @if ($component->component_data_type == 'connected') checked @else disabled @endif>
