    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card-box">
                ...
                <form data-action="/{{ app()->getLocale() }}/admin/component/{{ $componentable->id }}\edit"
                    user-id="{{ auth()->user()->id }}" method="POST">
                            ...
                            <div role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="{{ $locale }}[title]" parsley-trigger="change"
                                        value="{{ $componentable->translate($locale)->title ?? '' }}"
                                        class="@error('title') danger @enderror form-control inputparsley"
                    ...
                    <input type="hidden" name="name" value="{{ $componentable->name }}">
